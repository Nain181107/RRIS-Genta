            ...
            <div class="h-full bg-white p-2 md:p-3 border-2 border-gray-300 rounded-xl flex flex-col min-h-0 gap-2">
                ...
                <form id="historyFilterForm" class="w-full space-y-2">
                    ...
                    <div class="flex flex-wrap items-center gap-2 pt-2 justify-end">
                        ...
                        <button type="button" id="btnExport" data-export-url="{{ route('history.perbaikan.export') }}"
                ...
                <div class="flex-1 min-h-0 flex flex-col border-2 border-gray-300 rounded-lg p-2 overflow-hidden">
                    <div class="h-full rounded-lg overflow-auto">
                        <table class="w-full table-auto border-collapse">
                            <thead
                                class="bg-(--blue) sticky top-0 z-10 text-(--whitesmoke) text-sm font-semibold border-b whitespace-nowrap">
                                <tr>
                            ...
                            <tbody id="historyperbaikan-body" class="divide-y divide-gray-300 text-xs md:text-sm">
                                @include('history_data.partials.perbaikan.historyperbaikan-table-body')
                            </tbody>
                        </table>
                    </div>
                </div>
                ...
                <div id="historyperbaikan-info">
                    @include('history_data.partials.perbaikan.historyperbaikan-info', [
                        'perbaikan' => $perbaikan,
                    ])
                </div>
            </div>
                    ...
                    <div class="border-2 border-gray-300 rounded-md overflow-auto">
                        <table class="w-full table-auto border-collapse">
                            ...
                            <tbody id="identitas-awal-body" class="divide-y divide-gray-200 text-xs md:text-sm">
                                <tr>
                                    <td colspan="32" class="text-center py-4 text-gray-400">
...
@push('scripts')
    @vite(['resources/js/historyperbaikan.js'])
    <script>
