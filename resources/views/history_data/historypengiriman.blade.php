            ...
            <div class="h-full bg-white p-2 md:p-3 border-2 border-gray-300 rounded-xl flex flex-col min-h-0 gap-2">
                ...
                <form id="historyFilterForm" class="w-full space-y-2">
                    ...
                    <div class="flex flex-wrap items-center gap-2 pt-2 justify-end">
                        ...
                        <button type="button" id="btnExport" data-export-url="{{ route('history.pengiriman.export') }}"
                        ...
                        <table class="w-full table-auto border-collapse">
                            <thead
                                ...
                                <tr>
                                    ...
                                    <th class="px-4 py-3">Tanggal Pengiriman</th>
                            ...
                            <tbody id="historypengiriman-body" class="divide-y divide-gray-300 text-xs md:text-sm">
                                @include('history_data.partials.pengiriman.historypengiriman-table-body')
                            </tbody>
                        </table>
                    </div>
                </div>
                ...
                <div id="historypengiriman-info">
                    @include('history_data.partials.pengiriman.historypengiriman-info', [
...
@push('scripts')
    @vite(['resources/js/historypengiriman.js'])
    <script>
